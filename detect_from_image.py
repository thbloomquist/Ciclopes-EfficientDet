...
def load_image_into_numpy_array(path):
    ...
    #number = image.getdata()
    #print("Image Number value = ", number.astype(np.uint8))
    ...
    # IMAGES MUST BE 24-bit color value (.jpg)
...
#  python ./detect_from_image.py -m ssd_mobilenet_v2_320x320_coco17_tpu-8/saved_model -l ./data/mscoco_label_map.pbtxt -i ./test_images
# python ./detect_from_image.py -m ./Ciclopes-1/content/inference_graph/saved_model -l ./labelmap.pbtxt -i ./test_images/bowling_images